...
class Paginator {
    ...
    private $_query = 'se;ect * from products order by created_at desc';
    private $_total;
    private $_row_start;
    ...
    public function getData( $limit = 1, $page = 1 ) { //set default argument values
