                                    ...
                                    <div class="facts">
                                        <div class="register">
                                            <?php echo form_open('form/registration'); ?>
                                                <input placeholder="Name" name="username" value="<?php echo set_value('username'); ?>" type="text" required="">
                                                <input placeholder="Email Address" name="email" value="<?php echo set_value('email'); ?>" type="email"
                                                       required="">
